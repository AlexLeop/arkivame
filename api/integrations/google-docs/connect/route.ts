...
export async function GET(request: NextRequest) {
  ...
  const redirectUri = `${process.env.NEXTAUTH_URL}/api/integrations/google-docs/callback`;
  const scope = 'https://www.googleapis.com/auth/documents'; // Scope for Google Docs
